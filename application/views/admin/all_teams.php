					...
					<!-- TABLE STRIPED -->
					 <table class="table-striped-dflt">
						...
						<tr> 
							...
							<td><a href = "<?php echo base_url('/team_admin/delete/'). '/'.$data->team_id ;?>" onclick = "javascript:return confirm('Are you sure you want to delete this?');"><input class='DButton' type ='button' value = 'Delete'/></a></td>
